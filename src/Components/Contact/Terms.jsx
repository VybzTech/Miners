...
const Terms = ({ showTerms, setShowTerms }) => {
  ...
  const companyName = "Platinum Miners Service";
  // const portal =
  ...
  a.This page describes the terms and conditions (the “Terms”) that govern your use of ${companyLink} and the content or related services and products available on/or through ${companyLink} (including mobile applications and newsletters) and (also) any updates, new versions or new releases of those services and products. Individually and collectively, we’ll refer to these services and products as the “${serviceName}”.
  `}</p>

              <p>{`
  b.The ${serviceName} is provided by Platinum Ville Mines, Ltd. and its groups/affiliates, which we’ll refer to individually and collectively as “Ville affiliates,” “we”, “us”, or “our”.
  `}</p>

              <p>{`
  c.These Terms are for the benefit of each Ville affiliate and each Ville group affiliate may enforce these Terms.
  `}</p>

              <p>{`
  d.Certain features or components of the ${serviceName} may be subject to additional terms and conditions, including user guidelines or other rules, which will be posted on the applicable ${serviceName}. Those additional terms and conditions are part of these Terms.
  `}</p>

              <p>{`
  e.Please read this page carefully. You agree that by accessing, using and/or downloading the ${serviceName}, you agree to be legally bound and consent to these Terms. If any of these Terms are unacceptable to you, you must stop using the ${serviceName}. For those users who do not complete the registration process, your access to the ${serviceName} may be limited.
  `}</p>

              <p>{`
f.If you access the ${serviceName} under a group subscription agreement (e.g. Corporations, Organizations, institutions, etc.), then your access and use are also governed by that particular agreement between Ville individuals and your group. You agree that you are bound by and consent to all of these Terms; however if there is any inconsistency or dispute between these Terms and the group subscription agreement, then the terms of the relevant group subscription agreement will prevail to the extent of the inconsistency or dispute.
`}</p>

              <p>{`
g.If you access (or download) the ${serviceName} through any third party platform or ${companyLink}, the applicable terms and conditions for such third party platform or service may apply in addition to these Terms and you agree that you are subject to such application or platforms terms in addition to these Terms.
`}</p>
            </div>
            <div className="container">
            ...
            <div className="container">
              ...
              version on this site (and update the “Last updated on _____”
            ...
            <div className="container">
              ...
              From time to time, we may make changes to the ${serviceName}{" "}
              without prior notice, which could include modifying,
            ...
            <div className="container">
              <h2>Registration</h2>
              a.As part of the registration process, you will be required to
              ...
              registered users. b.You agree and promise that the information
              ...
              promptly inform us of any changes to your information. c.You are
              ...
              https://liaison.reuters.com/contact-us. d.If you fail to comply
            ...
            <div className="container">
              ...
              a.All the materials on the Service — the text, photographs, video,
              audio, graphics, metadata, quotes, data, information, the overall
              “look and feel,” and all protectable intellectual property
              (collectively, the “Content”) - is the property of Reuters or, in
              some cases, its licensors. b.The Service and Content are protected
              ...
              of Reuters and the Reuters group affiliates and/or our licensors.
              No intellectual property rights in the Content or in the Service
              are transferred to you. c.Except for the limited license described
              ...
              d.For further information, including about purchasing re-prints of
              certain Content through our third-party providers, please refer to
              the Thomson Reuters Copyright page, which is part of these Terms.
            </div>
            <div className="container">
              <h2>Restrictions on Use</h2>
              a.THE SERVICE AND THE CONTENT IS PROVIDED BY REUTERS AND ITS
              ...
              the Service in your personal, individual capacity (except, if
              ...
              any manner that could compete with the business of Reuters or any
              ...
              written consent. c.Without our prior written consent: You may not
              ...
              other users. d.You promise to abide by exclusionary protocols
              (such as Robots.txt, Automated Content Access Protocol (ACAP),
              etc.) that may be used in connection with the Service. e.Engaging
            ...
            <div className="container">
              ...
              Service where you can provide User Material. b.You agree that you
              ...
              federal, national or international law or regulation. c.By posting
              ...
              it. d.You agree that by uploading, submitting, or posting User
            ...
            <div className="container">
              ...
              a.The Service may include content created by third parties,
              ...
              from third parties. b.We do not guarantee the accuracy of or
              endorse the views or opinions given by such third parties. We are
              not responsible for, and do not control such non-Reuters websites,
            ...
            <div className="container">
              <h2>Other Thomson Reuters Services</h2>
              Other Thomson Reuters-related entities may discuss, offer, or
              promote additional services on the Service. Those services may be
              outside the scope of these Terms and may require a separate
              agreement with the appropriate Thomson Reuters entity.
            </div>
            <div className="container">
              <h2>Limitations of Our Service and Content</h2>
              a.The Service and Content are provided for informational purposes
              ...
              that or any other security, financial product, or investment. b.We
              ...
              of the Service or the Content is at your sole risk. c.We do not
            ...
            <div className="container">
              <h2>Our Financial Responsibility to You</h2>
              To the fullest extent permitted under applicable law, we will not
              be liable—jointly or severally—for any direct, indirect,
              consequential, special, incidental, punitive, or exemplary
              damages, including but not limited to lost profits, lost savings,
              and lost revenues, whether in negligence, tort, contract, or any
              other theory of liability, even if we have been advised of the
              possibility of such damages or could have foreseen any such
              damages. The limitations of liability in these Terms shall apply
              for the benefit of our officers, directors, employees, agents, or
              any company to whom we may transfer our rights and obligations to
            ...
            <div className="container">
              ...
              a.These Terms shall (to the fullest extent permitted under
              ...
              objections to such courts. b.Any claim or cause of action arising
            ...
            <div className="container">
              <h2>General</h2>
              a.These Terms contain the entire agreement between us regarding
              your use of the Service and supersedes all previous agreements (if
              any). b.If a court or other valid authority determines that any
              ...
              otherwise be affected. c.If we do not enforce any provision of the
